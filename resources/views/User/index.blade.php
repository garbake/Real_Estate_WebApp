...
<h2 class="my-6 text-2xl font-semibold text-gray-700 dark:text-gray-200">
                    ...
                    <form action="{{ route('users.import') }}" method="POST" enctype="multipart/form-data">
                      ...
                      <label class=" rounded-lg border border-gray-200 bg-white px-5 py-3 text-gray-500 transition hover:text-gray-700 focus:outline-none focus:ring cursor-pointer">
                        <span class="text-sm font-medium">Import Users</span>
            ...
            <div class=" mt-4 w-full overflow-hidden rounded-lg shadow-xs border">
                    ...
                    <td class="px-4 py-3 text-sm">
                      ...
                      <td class="px-4 py-3">
                        <div class="flex items-center text-sm">
                          ...
                          <i class="fa-solid fa-circle-user fa-xl mt-3"></i>
                          <!-- <img
    ...
    <script>
  // When the visible button is clicked, trigger the hidden file input element
