    ...
    <div class="mx-auto max-w-xl text-center">
      ...
      <div class="mt-8 flex flex-wrap justify-center gap-4">
        <a
          ...
          class="block w-full rounded  bg-teal-600 px-12 py-3 text-sm font-medium text-white shadow hover:bg-teal-500 focus:outline-none focus:ring active:bg-rose-500 sm:w-auto transition-colors duration-300 ease-in-out"
        >
          Get Started
        </a>
        ...
        <a
          href="#"
          class="block w-full rounded bg-white px-12 py-3 text-sm font-medium text-teal-600 shadow hover:text-teal-500 focus:outline-none focus:ring active:text-rose-500 sm:w-auto transition-colors duration-300 ease-in-out"
        >
          Learn More
        </a>
