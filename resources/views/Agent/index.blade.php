                  ...
                  @foreach($properties as $property)
                    ...
                    <td class="px-4 py-3 text-sm">
                      ...
                      <td class="px-4 py-3">
                        ...
                        <a href="{{route('property.show', $property->id)}}" class="flex items-center justify-between px-2 py-2 text-sm font-medium leading-5 text-purple-600 rounded-lg dark:text-gray-400 focus:outline-none focus:shadow-outline-gray" aria-label="show">
